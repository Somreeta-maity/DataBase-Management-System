...
<form action="Vendor_update3.php" method="post">
<table >
<tr>
<th>VendorName</th>
<th>Address</th>
...
<th>Emailid</th>
 ...
 <td><input type ="text" name ="VendorName" value="<?php echo $a;?>" ></td>
<td><input type="text"  name="Address"value="<?php echo $b;?>" ></td>
<td><input type="text" name="MobileNo" value="<?php echo $c;?>"></td>
 <td><input type="email"  name="Emailid"value="<?php echo $d;?>"></td>
